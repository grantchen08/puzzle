...
- **Background Music:** Retro chiptune-style music generated in JavaScript (Web Audio) — currently plays **"Twinkle Twinkle Little Star"**. Starts after your first input (browser autoplay rules) and follows the mute toggle.
