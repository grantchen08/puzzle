...
- **Background Music:** Soothing, flute-like melodies generated in JavaScript (Web Audio). Plays a **shuffled playlist of public-domain tunes** (e.g. **Twinkle Twinkle Little Star**, **Frère Jacques**, **Mary Had a Little Lamb**, **Ode to Joy**, **Row Row Row Your Boat**). Uses advanced synthesis with harmonics, subtle vibrato, and breath-like envelopes to create a realistic flute timbre. Slower tempos for a peaceful, relaxing experience. Starts after your first input (browser autoplay rules) and follows the mute toggle.
